...
const Word localization_IT = {
    ...
    .uartError_generalFailure = "UART errore: Fallimento generale.",
    ...
    .sdCardError_init = "SD CARD errore: Inizio.",
    .sdCardError_mount = "SD CARD errore: Montaggio.",
    .sdCardError_open = "SD CARD error: Apertura."};
